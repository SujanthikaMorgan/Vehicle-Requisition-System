<?php
    ...
    $select_query="SELECT * FROM `Trip` ORDER BY Trip_No DESC";
        ...
        <div class="row">
           <div class="col-md-12">
             <div class="page-header">
              ...
              <table class="table table-bordered animated bounce" id="myTable">
                <thead>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-primary" href="bill.php?id=<?php echo $row['booking_id']; ?>">Bill</a></td> 
                         <?php } else if($row['paid']==1 ) { ?>
                          ...
                          <td><a href="confirmpayment.php?id=<?php echo $row['Trip_No']; ?>">Confirm</a></td>

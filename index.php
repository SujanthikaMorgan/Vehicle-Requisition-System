...
<head>
    <meta charset="UTF-8">
    <title>Vehicle Requisition System FOE,UOJ</title>
...
.parallax {
    /* The image used */
    background-image: url("transportation-services-unit-ulasim-isleri-sube-amirligi.jpg");
    height: 100%;
    ...
    <div class="parallax foo">
       <?php include 'navbar.php';?>
        ...
        <div class="hero-text" style="font-size:50px text-align: center; position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);color: white;">
            ...
            <h1 class="animated rubberBand" >University Vehicle Requisition System</h1>
            <p>A system where you can request for vehicles and manage them</p>
        ...
        <footer style="background-color: #2f2f2f;
          ...
          padding-bottom: 10px;" class="container-fluid text-center">
                <p>All rights reserved by Sujanthika Morgan</p>
        </footer>
